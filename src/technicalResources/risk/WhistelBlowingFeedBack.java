 ...
 */
@WebServlet("/WhistelBlowingFeedBack")
public class WhistelBlowingFeedBack extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/workingResources/whistelBlowingFeedBack.jsp");
	...
	protected void doPost(HttpServletRequest request,
		...
		String aboutFeedBackSubject = request
				.getParameter("aboutFeedBackSubject");
		String aboutFeedBackDetail = request
				.getParameter("aboutFeedBackDetail");
		ConnectionHelper connectionHelper = new ConnectionHelper();
		con = connectionHelper.connect();
		String insertIssueSql = "INSERT INTO [dbo].[WhistelBlowingFeedBack] ([dateNow],[userName] ,[aboutFeedBackSubject] ,[aboutFeedBackDetail]) VALUES (?,?,?,?);";
		...
		try {
			...
			try {
				...
				message.addRecipient(Message.RecipientType.TO,
						new InternetAddress("MbongeniB@swazibank.co.sz"));
				message.addRecipient(Message.RecipientType.TO,
						new InternetAddress("thembumenzik@swazibank.co.sz"));
				message.addRecipient(Message.RecipientType.TO,
						new InternetAddress("NobesuthuS@swazibank.co.sz"));
				message.addRecipient(Message.RecipientType.TO,
						new InternetAddress("robertk@swazibank.co.sz"));

				// Set Subject: header field
				message.setSubject("New whistle blow about: "
						+ aboutFeedBackSubject + " Requires your Attention");

				// Now set the actual message
				message.setText("Dear " + "Risk Department" + "\nA message for the whistle blowing platform has been submitted as follows: \n\n" + aboutFeedBackDetail+ "\n\nThis mail is Auto generated. " + "\n"
						+ "kind regards" + "\n Anonymous");
