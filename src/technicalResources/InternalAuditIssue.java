 ...
 */
@WebServlet("/IntenralAuditIssue")
public class InternalAuditIssue extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (con != null) {
				...
				while (results.next()) {
					...
					Date aDate = null;
					try {
						aDate = dateFormat.parse(auditDate);
					} catch (ParseException e) {
						
						System.out.println("The date is not defined");;
					}
					int daysLapsed = (int) (date.getTime()-aDate.getTime());
