...
/**
 * Servlet implementation class ChangeManagement
 */
@WebServlet("/WellnessResources")
public class WellnessResources extends HttpServlet {
	private static final long serialVersionUID = 1L;

	String directoryName = "C:/IntranetWarehouse/WellnessResources";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/technicalResources_corporateServices/wellnessResources.jsp");
	...
	public void destroy() {
		...
		String servletName = "Briefs and News";
