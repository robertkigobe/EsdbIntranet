 ...
 */
@WebServlet("/ChangeManagement")
public class ChangeManagement extends HttpServlet {
	private static final long serialVersionUID = 1L;

	String directoryName = "C:/IntranetWarehouse/ChangeManagement";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/technicalResources_corporateServices/changeManagement.jsp");
