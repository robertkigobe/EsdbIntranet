 ...
 */
@WebServlet("/BranchLoanCreditAnalystComment")
public class BranchLoanCreditAnalystComment extends HttpServlet {
		...
		if (viewLoan != null) {
			...
			if (con != null) {
				String sql = "UPDATE [SwaziBankIntranet2016].[dbo].[branchLoan] "
						...
						+ lastModifiedDate
						+ "'"
						+ ",[loanStatus] = 'Pending Credit Manager Comments'"
