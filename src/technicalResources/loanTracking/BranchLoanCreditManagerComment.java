 ...
 */
@WebServlet("/BranchLoanCreditManagerComment")
public class BranchLoanCreditManagerComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		creditManagerCommentDate = dateCreated;
		...
		// double totalRepayment2 = -(FinanceLib.pmt(r, loanPeriod,
		// totalRepayment, finalValue, false));
		...
		if (viewLoan != null) {
			...
			if (con != null) {
				String sql = "UPDATE [SwaziBankIntranet2016].[dbo].[branchLoan] "
						...
						+ ",[lastModifiedDate] = '"
						+ lastModifiedDate+ "'"
						+ ",[loanStatus] = 'Pending Sanction and securities signing'"
				...
				try {
					...
					try {
						...
						message.setText("Dear "
								...
								+ loanReference
								+ "."
								+ "\nPlease Click on the link http://localhost:8080/EsdbLoanAutomation/BranchLoanCreditAnalystRequest to comment."
								+ "\n\n"
