 ...
 */
@WebServlet("/BranchLoanNewApplication")
public class BranchLoanNewApplication extends HttpServlet {
...
/*
		...
		if (con != null) {
			...
			String sql = "SELECT  Top 1 id FROM [dbo].[branchLoan] order by ID desc";
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/tehcnicalResources_loanTracking/branchLoanNewApplication.jsp");
		...
		*/
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/tehcnicalResources_loanTracking/branchLoanNewApplication.jsp");
		//RequestDispatcher view = request.getRequestDispatcher("WEB-INF/utilities/datewidget.jsp");
		view.forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String applicationLoanRef;
		int applicationMonth1;
		String applicationMonth;
		int applicationYear;
		...
		String branchManagerSecuritiesComment;
		String branchManagerSecuritiesCommentDate;
		...
		float cashAtBank;
		String cif;
		String copyOfConcifirmationLetter;
		String copyOfId;
		String copyOfItcReport;
		String copyOfPaySlip;
		...
		double loanAmount;
		double loanAmount1;
		String loanAmountApplied;
		float loanAmountDisbursed;
		float loanAmountTotal;
		...
		String Other5;
		float otherAccounts;
		float otherAccountsBudget;
		float otherAssets;
		float otherDebts;
		float otherDeductionBudget;
		float otherDeductions;
		float otherIncome;
		float outstandingLoanBalance;
		float overdrafts;
		float pension;
		...
		String securitiesSupervisorCommentDate;
		String securitiesSupervisorEmail;
		String securitiesSupervisorName;
		String SecurityLink;
		String SecurityUploadDate;
		float surplus;
		...
		applicantBankAccountNumber = request.getParameter("applicantBankAccountNumber");
		...
		applicantNearestShop_school = request.getParameter("applicantNearestShop_school");
		...
		bankExecutionerCapacity = request.getParameter("bankExecutionerCapacity");
		...
		branchManagerCommentDate = request.getParameter("branchManagerCommentDate");
		branchManagerSecuritiesComment = request.getParameter("branchManagerSecuritiesComment");
		branchManagerSecuritiesCommentDate = request.getParameter("branchManagerSecuritiesCommentDate");
		...
		businessConsultantCommentDate = dateCreated;
		businessConsultantComment = request.getParameter("businessConsultantComment");
		businessConsultantEmail = request.getParameter("businessConsultantEmail");
		...
		creditAnalystCommentDate = request.getParameter("creditAnalystCommentDate");
		...
		debtorsName1Amount = Float.valueOf(request.getParameter("debtorsName1Amount"));
		debtorsName2Amount = Float.valueOf(request.getParameter("debtorsName2Amount"));
		debtorsName3Amount = Float.valueOf(request.getParameter("debtorsName3Amount"));
		debtorsName4Amount = Float.valueOf(request.getParameter("debtorsName4Amount"));
		...
		employerPhysicalAddress = request.getParameter("employerPhysicalAddress");
		...
		foodBudget = Float.valueOf(request.getParameter("foodBudget"));
		...
		insurancesBudget = Float.valueOf(request.getParameter("insurancesBudget"));
		interestRate = 22;
		instalment = 0;
		...
		loanStatus = "Pending Branch Manager Comments";
		loanAmount = Float.valueOf(request.getParameter("loanAmount"));
		loanAmount1 = Double.valueOf(request.getParameter("loanAmount"));
		loanAmountApplied = request.getParameter("loanAmount");
		loanAmountDisbursed = 0;
		loanAmountTotal = 0;
		loanAmountWords = request.getParameter("loanAmountWords");
		loanOpeningSupervisorName = request.getParameter("loanOpeningSupervisorName");
		loanOpeningSupervisorCommentDate = request.getParameter("loanOpeningSupervisorCommentDate");
		loanOpeningSupervisorComment = request.getParameter("loanOpeningSupervisorComment");
		loanOpeningSupervisorEmail = request.getParameter("loanOpeningSupervisorEmail");
		...
		noOfDependants = Integer.valueOf(request.getParameter("noOfDependants"));
		...
		otherDeductions = Float.valueOf(request.getParameter("otherDeductions"));
		...
		previouslyAppliedforLoanwithSdsb = request.getParameter("previouslyAppliedforLoanwithSdsb");
		previousLoanBalances = Float.valueOf(request.getParameter("previousLoanBalances"));
		...
		referenceName1PhysicalAddress = request.getParameter("referenceName1PhysicalAddress");
		referenceName2PhysicalAddress = request.getParameter("referenceName2PhysicalAddress");
		referenceName3PhysicalAddress = request.getParameter("referenceName3PhysicalAddress");
		referenceName1TelephoneNo = request.getParameter("referenceName1TelephoneNo");
		referenceName2TelephoneNo = request.getParameter("referenceName2TelephoneNo");
		referenceName3TelephoneNo = request.getParameter("referenceName3TelephoneNo");
		registryOfficerComment = request.getParameter("registryOfficerComment");
		registryrOfficerCommentDate = request.getParameter("registryrOfficerCommentDate");
		...
		loansBudget = Float.valueOf(request.getParameter("loansBudget"));
		otherDeductionBudget = Float.valueOf(request.getParameter("otherDeductionBudget"));
		outstandingLoanBalance = 0;
		surplus = Float.valueOf(request.getParameter("surplus"));
		surplusLiabilities = Float.valueOf(request.getParameter("surplusLiabilities"));
		tax = Float.valueOf(request.getParameter("tax"));

		copyOfConcifirmationLetter = request.getParameter("copyOfConcifirmationLetter");
		copyOfId = request.getParameter("copyOfId");
		copyOfItcReport = request.getParameter("copyOfItcReport");
		copyOfPaySlip = request.getParameter("copyOfPaySlip");
		currentLoanBalances = request.getParameter("currentLoanBalances");
		currentLoans = request.getParameter("currentLoans");
		inactivity = null;
		lastDateModified = dateCreated;

		loanType = request.getParameter("loanType");
		Other1 = request.getParameter("Other1");
		Other2 = request.getParameter("Other2");
		Other3 = request.getParameter("Other3");
		Other4 = request.getParameter("Other4");
		Other5 = request.getParameter("Other5");

		otherAccountsBudget = Float.valueOf(request.getParameter("otherAccountsBudget"));
		resAddress = request.getParameter("resAddress");
		securitiesDocumentLocation = request.getParameter("securitiesDocumentLocation");
		securitiesDocumentUploadDate = request.getParameter("securitiesDocumentUploadDate");
		securitiesSupervisorComment = request.getParameter("securitiesSupervisorComment");
		securitiesSupervisorCommentDate = request.getParameter("securitiesSupervisorCommentDate");
		securitiesSupervisorEmail = request.getParameter("securitiesSupervisorEmail");
		securitiesSupervisorName = request.getParameter("securitiesSupervisorName");
		SecurityLink = request.getParameter("SecurityLink");
		SecurityUploadDate = request.getParameter("SecurityUploadDate");
		taxIdentity = request.getParameter("taxIdentity");
		telelephoneNo = request.getParameter("telelephoneNo");

		loanReference = branch + ": " + iDNumber + ": " + lastId;
		applicationLoanRef = loanReference;

		water = Float.valueOf(request.getParameter("water"));
		waterBudget = Float.valueOf(request.getParameter("waterBudget"));
		...
		try{ 
			...
			Date doBirth = inSdf.parse(dateOfBirth);
			dob = outSdf.format(doBirth);
		...
		try {
			...
			applicationDay1 = localDate.getDayOfMonth();
			applicationMonth1 = localDate.getMonthValue();
			applicationYear = localDate.getYear();
		...
		//double totalRepayment2 = -(FinanceLib.pmt(r, loanPeriod, totalRepayment, finalValue, false));

		long millis = System.currentTimeMillis();
		java.sql.Date date = new java.sql.Date(millis);
		int customerAge = (int) ChronoUnit.YEARS.between(LocalDate.parse(dob).withDayOfMonth(1),
		...
		double totalRepayment = -(FinanceLib.pmt(r, loanPeriod, loanAndCharges, finalValue, false)) + managementFee;

		if (viewLoan != null) {
			// TODO Auto-generated method stub

			Font blackFont1 = FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL);
			Font blackFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 9, Font.NORMAL);
			...
			try {
				...
				Paragraph atmotizationHeading = new Paragraph("PERSONAL LOAN ARMOTIZATION\n\n", blackFontListHeading);
				...
				do {
					...
					ftable2.addCell(new Paragraph(String.valueOf(x1), blackFont1));
					ftable2.addCell(new Paragraph(dateTime, blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(beginingBalance), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(totalRepayment), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(extraPayment), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(totalPayment), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(principal), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(interest), blackFont1));
					ftable2.addCell(new Paragraph(formatter.format(endingBalance), blackFont1));
					x1++;
				...
				ftable1.addCell(new Paragraph(String.valueOf(interestRate) + "%", blackFont1));
				ftable1.addCell(new Paragraph("Scheduled # of   Payments", blackFont1));
				ftable1.addCell(new Paragraph(String.valueOf(loanPeriod), blackFont1));
				...
				resumeTable1.addCell(new Paragraph("CUSTOMER NAME", blackFont1));
				resumeTable1.addCell(new Paragraph(applicantName, blackFont1));
				resumeTable1.addCell(new Paragraph("POSTAL ADDRESS", blackFont1));
				...
				resumeTable1.addCell(new Paragraph("PLACE OF EMPLOYMENT", blackFont1));
				...
				resumeTable2.addCell(new Paragraph("ACTUAL LOAN AMOUNT", blackFont));
				resumeTable2.addCell(new Paragraph("", blackFont1));
				resumeTable2.addCell(new Paragraph("REQUESTED LOAN AMOUNT", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (loanAmount)), blackFont1));
				resumeTable2.addCell(new Paragraph("INITIATION FEE", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (initiationfee)), blackFont1));
				resumeTable2.addCell(new Paragraph("TOTAL LOAN AMOUNT (Requested Loan + Charges)", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (loanAndCharges)), blackFont1));
				resumeTable2.addCell(new Paragraph("INITIATION FEE", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (initiationfee)), blackFont1));
				resumeTable2.addCell(new Paragraph("LEVEL TERM INSURANCE", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (levelTermInsurance)), blackFont1));
				resumeTable2.addCell(new Paragraph("TOTAL PREMIUMS TO BE REMITTED TO INSURANCE", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (levelTermInsurance)), blackFont1));
				resumeTable2.addCell(new Paragraph("TOTAL LOAN AMOUNT", blackFont1));
				resumeTable2.addCell(new Paragraph(String.format("%.2f", (loanAndCharges)), blackFont1));
				...
				resumeTable3.addCell(new Paragraph("OTHER INFORMAITON", blackFont));
				resumeTable3.addCell(new Paragraph("", blackFont1));
				resumeTable3.addCell(new Paragraph("INTEREST", blackFont1));
				resumeTable3.addCell(new Paragraph(String.format("%.2f", (interestRate)), blackFont1));
				...
				resumeTable3.addCell(new Paragraph((String.valueOf(loanPeriod)), blackFont1));
				resumeTable3.addCell(new Paragraph("PRINCIPAL REPAYMENT", blackFont1));
				resumeTable3.addCell(new Paragraph(String.format("%.2f", (totalRepayment - managementFee)), blackFont1));
				resumeTable3.addCell(new Paragraph("MANAGEMENT FEE", blackFont1));
				resumeTable3.addCell(new Paragraph(String.format("%.2f", (managementFee)), blackFont1));
				resumeTable3.addCell(new Paragraph("TOTAL REPAYMENT", blackFont1));
				resumeTable3.addCell(new Paragraph(String.format("%.2f", (totalRepayment)), blackFont1));
				resumeTable3.addCell(new Paragraph("CUSTOMER CIF", blackFont1));
				resumeTable3.addCell(new Paragraph(cif, blackFont1));
				resumeTable3.addCell(new Paragraph("BANKERS REPORT", blackFont1));
				resumeTable3.addCell(new Paragraph(businessConsultantComment, blackFont1));
				...
				resumeTable4.addCell(new Paragraph(String.format("%.2f", (basicSalary)), blackFont1));
				resumeTable4.addCell(new Paragraph("PROPOSED MONTHLY REPAYMENT", blackFont1));
				resumeTable4.addCell(new Paragraph(String.format("%.2f", (totalRepayment)), blackFont1));
				resumeTable4.addCell(new Paragraph("OTHER LOANS DEDUCTION", blackFont1));
				resumeTable4.addCell(new Paragraph((String.valueOf(debtorsName1Amount)), blackFont1));
				resumeTable4.addCell(new Paragraph("OTHER LOANS DEDUCTION", blackFont1));
				resumeTable4.addCell(new Paragraph((String.valueOf(debtorsName2Amount)), blackFont1));
				resumeTable4.addCell(new Paragraph("OTHER LOANS DEDUCTION", blackFont1));
				resumeTable4.addCell(new Paragraph((String.valueOf(debtorsName3Amount)), blackFont1));
				resumeTable4.addCell(new Paragraph("TOTAL DEDUCTIONS", blackFont1));
				resumeTable4.addCell(new Paragraph(String.format("%.2f", (totalRepayment)), blackFont1));
				resumeTable4.addCell(new Paragraph("COMMITMENT", blackFont1));
				resumeTable4.addCell(new Paragraph("", blackFont1));
				resumeTable4.addCell(new Paragraph("", blackFont1));
				resumeTable4.addCell(new Paragraph("", blackFont1));
				resumeTable4.addCell(new Paragraph("PREVIOUS LOAN AMOUNT", blackFont1));
				resumeTable4.addCell(new Paragraph(String.valueOf(previousLoanBalances), blackFont1));
			...
			if (con != null) {
				String insertIssueSql = "INSERT INTO branchLoan ("
						+ "administationFee, "
						...
						+ "branchManagerEmail,"
						+ "branchManagerName," 
						+ "branchManagerSecuritiesComment,"
						+ "branchManagerSecuritiesCommentDate," 
						...
						+ "securitiesSupervisorCommentDate,"
				...
				try {
					...
					response.sendRedirect(request.getContextPath() + "/BranchLoanTrackingStatus");
					String to = branchManagerEmail;
					...
					try {
						...
						message.setSubject(
								"Branch Loan Submitted by: " + businessConsultantName + " Requires your Attention");
						message.setText("Dear Mr/Ms " + branchManagerName + "\n\n"
								+ "A new Personal Loan has been Submitted by: "

								+ "  " + businessConsultantName.toUpperCase() + " with reference: " + loanReference
								+ "."
								+ "\nPlease Click on the link http://live-intranet:8080/EsdbLoanAutomation/BranchLoanBranchManagerRequest to comment."
								+ "\n\n" + "This mail is Auto generated. Please Contact the Applicant on "
								+ businessConsultantEmail + " for additional Information." + "\n" + "\n warm regards"
								+ "\n IT Department");
