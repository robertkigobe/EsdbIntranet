 ...
 */
@WebServlet("/StaffLoanUpdateSeniorHrManagerComment")
public class StaffLoanUpdateSeniorHrManagerComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		request.getParameter("hod");
		request.getParameter("hodComment");
		...
		String hrPayrollMasterComment = request
				.getParameter("hrPayrollMasterComment");
		//String hrPayrollMasterCommentDate = dateCreated;
		...
		double loanAmount1 = Double.valueOf(request.getParameter("loanAmount"))
				- Double.valueOf(levelTermInsurances);
		request.getParameter("loanAmountWords");
		int loanPeriod = 0;
		...
		String seniorHrManagerEmail = request.getParameter("seniorHrManagerEmail");
		String seniorHrManagerComment = request.getParameter("seniorHrManagerComment");
		//String startDate1 = request.getParameter("dateOfFirstInstallment");
		//Date startDate2 = null;
		request.getParameter("supervisorComment");
		request
		...
		// /////////////date insert///////////////////
				...
				String seniorHrManagerCommentDate = sdf.format(legalAdvisorCommentDateN);
				lastModifiedDate = seniorHrManagerCommentDate;
				// /////////////date insert///////////////////
		...
		float funeralCover = Float.valueOf(request.getParameter("funeralCover"));
		...
		if (loanStatus.equals("Cancel")) {
				...
				try {
					...
					try {
						...
						message.setText("Dear "
								...
								+ "Your Loan Staff Application  with Reference: "
								+ employeeLoanRef
								+ " has been returned for your action. Please click on the link to edit your loan: http://172.16.1.59:8090/EsdbIntranet/StaffLoanEditLoan"
								+ "\n"
			...
			try {
				...
				table.addCell(new Paragraph((firstname + " " + surname),
						blackFont1));
				...
				table.addCell(new Paragraph("Basic Monthly Salary: ",
						blackFont1));
				table.addCell(new Paragraph(String.valueOf(basicSalary),
						blackFont1));
				...
				table.addCell(new Paragraph((String.valueOf(noOfDependants)),
						blackFont1));
				...
				table61.addCell(new Paragraph(("3. Loan Type: " + loanType),
						blackFont1));
				...
				Paragraph applicationLetterParagraph30 = new Paragraph(
						"4.	RECENT SALARY ADVICE DETAILS", blackFontListHeading);
				...
				table1.addCell(new Paragraph((" E " + String.valueOf(Float
						.valueOf(basicSalary))), blackFont1));

				table1.addCell(new Paragraph(
						("Allowances (exc. Overtime& leave all:"), blackFont1));
				table1.addCell(new Paragraph((" E " + String.valueOf(Float
						.valueOf(allowances))), blackFont1));

				table1.addCell(new Paragraph(("Total Earnings:"), blackFont1));
				table1.addCell(new Paragraph((" E " + String.valueOf(Float
						.valueOf(allowances) + Float.valueOf(basicSalary))),
						blackFont1));

				document.add(table1);

				Paragraph applicationLetterParagraph31 = new Paragraph(
						"Current Loans and Balances: ", blackFontListHeading);
				...
				table2.addCell(new Paragraph(("(4) Housing Loan (Mortgage)"),
						blackFont1));
				table2.addCell(new Paragraph((" E " + String.valueOf(Float
						.valueOf(housingloanDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(housingloanBalance))), blackFont1));

				table2.addCell(new Paragraph(("(5) Rural Housing Loan"),
						blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(ruralHousingloanDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(ruralHousingloanBalance))), blackFont1));

				table2.addCell(new Paragraph(("(6) Farm / Small Holder"),
						blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(farm_smallHolderDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(farm_smallHolderBalance))), blackFont1));

				table2.addCell(new Paragraph(("(7) Car Loan"), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(carloanDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(carloanBalance))), blackFont1));

				table2.addCell(new Paragraph(("(8) Personal Loan (36 Months)"),
						blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(personalloanDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(personalloanBalance))), blackFont1));

				table2.addCell(new Paragraph(
						("(9) Educational Loan (12 Months)"), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(educationalloanDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(educationalloanBalance))), blackFont1));

				table2.addCell(new Paragraph(("(11) City Council Rates"),
						blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(cityCouncilRatesDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(cityCouncilRatesBalance))), blackFont1));

				table2.addCell(new Paragraph(("(12) Insurances"), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(insurancesDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(insurancesBalance))), blackFont1));

				table2.addCell(new Paragraph(("(13) Other Loans"), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(otherDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(otherBalance))), blackFont1));

				table2.addCell(new Paragraph(("(14) Total"), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(totalDeductions))), blackFont1));
				table2.addCell(new Paragraph((" E " + String.format("%.2f",
						(totalBalances))), blackFont1));
				...
				table3.addCell(new Paragraph((" E " + String
						.valueOf(otherDeductionsExcLeaveAllowance)), blackFont1));
				...
				table3.addCell(new Paragraph(
						("(17) Statutory Deductions(Paye+ Snpf)"), blackFont1));
				table3.addCell(new Paragraph((" E " + String
						.valueOf(statutoryDeductions)), blackFont1));

				table3.addCell(new Paragraph(
						("(18) NET SALARY (3) -  (14,15,16, 17)"), blackFont1));
				table3.addCell(new Paragraph((" E " + String.format("%.2f",
						(netSalary))), blackFont1));
				...
				table7.addCell(new Paragraph(
						("INTEREST RATE:" + interestRate + "%"), blackFont1));
				table7.addCell(new Paragraph(
						("REPAYMENT PERIOD IN MONTHS: " + loanPeriod),
						blackFont1));
				table7.addCell(new Paragraph(("INSTALMENT:" + " E " + String
						.format("%.2f", (totalRepayment))), blackFont1));

				table7.addCell(". ");
				table7.addCell(". ");
				table7.addCell(new Paragraph(("CUM. PERCENTAGE (14 +19) / 3:"),
						blackFont1));
				...
				table7.addCell(". ");
				table7.addCell(". ");
				table7.addCell(new Paragraph(("19. NET PAY (18) – (19) :"),
						blackFont1));
				table7.addCell(new Paragraph((" E " + String.format("%.2f",
						(netSalary - totalRepayment))), blackFont1));
			...
			if (con != null) {
				...
				+ "employeePosition = '" + employeePosition + "',"
						...
						+ "hrPayrollMasterComment = '"+ hrPayrollMasterComment + "',"
 						+ "iDNumber = '"+ iDNumber + "'," 
						...
						+ "seniorHrManagerComment = '" + seniorHrManagerComment	+ "'," 
						+ "seniorHrManagerCommentDate ='" + lastModifiedDate	+ "'," 
				...
				try {
					...
					try {
						...
						// Set Subject: header field
						message.setSubject("Prepare Securities for your Loan Application ");
						...
						message.setText("Dear "
								...
								+ ", \n"
								+ "\n"
								+ "Your Staff Loan with Reference: '"
								+ employeeLoanRef
								+ "' requires your immediate attention. "
								+ "\n"
								+ "Please Click on the link http://live-intranet:8090/EsdbIntranet/StaffLoanEmployeeSecuritiesRequest to generate or update your securities."
