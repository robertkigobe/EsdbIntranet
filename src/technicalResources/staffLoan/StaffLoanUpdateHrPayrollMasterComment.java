 ...
 */
@WebServlet("/StaffLoanUpdateHrPayrollMasterComment")
public class StaffLoanUpdateHrPayrollMasterComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String hodComment = request.getParameter("hodComment");
		String hodCommentDate = dateCreated;
		...
		String hrPayrollMasterEmail =  request.getParameter("hrPayrollMasterEmail");
		String hrPayrollMasterComment =  request.getParameter("hrPayrollMasterComment");
		...
		if (loanStatus.equals("Cancel")) {
			...
			if (con != null) {
				...
				String insertIssueSql = "UPDATE [dbo].[staffLoan] " + "SET  "
						...
						+ "[hrPayrollMasterCommentDate]  = '" + hrPayrollMasterCommentDate + "',"
			...
			if (con != null) {
				...
				String insertIssueSql = "UPDATE [dbo].[staffLoan] " + "SET  "
						+ "[loanStatus] = 'Return to Staff for editing',"
						+ "[hrPayrollMasterComment] = '" + hrPayrollMasterComment + "', "
						+ "[hrPayrollMasterCommentDate]  = '" + hrPayrollMasterCommentDate + "',"
						+ "[lastModifiedDate]  = '" + lastModifiedDate + "',"
						+ "[lastModifiedBy]  = '" + lastModifiedBy + "'"
			...
			if (con != null) {
				...
				try {
					...
					// Recipient's email ID needs to be mentioned.
					String to = seniorHrManagerEmail;
					...
					try {
						...
						// Now set the actual message
						message.setText("Dear Senior HR, \n"
								+ "\n"
								...
								+ "\n"
								+ "Please Click on the link http://172.16.1.59:8090/EsdbIntranet/StaffLoanSeniorHrManagerRequest for your comment."
