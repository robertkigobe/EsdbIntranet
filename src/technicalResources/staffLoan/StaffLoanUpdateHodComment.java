 ...
 */
@WebServlet("/StaffLoanUpdateHodComment")
public class StaffLoanUpdateHodComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String hrPayrollMasterEmail =   "machawem@swazibank.co.sz";
		...
		if (con != null) {
			...
			try {
				...
				while (results.next()) {
					...
					hrPayrollMasterEmail = "robertk@swazibank.co.sz";
			...
			if (viewLoan != null) {
				...
				if (con != null) {
					...
					try {
						...
						// Recipient's email ID needs to be mentioned.
						String to = hrPayrollMasterEmail;
						...
						try {
							...
							message.setText("Dear HR, \n"
									...
									+ "\n"
									+ "Please Click on the link http://live-intranet:8090/EsdbIntranet/StaffLoanPayrollMasterRequest for your comment."
