 ...
 */
@WebServlet("/BusinessBankingLoanFinanceComments")
public class BusinessBankingLoanFinanceComments extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (con != null) {
			...
			String insertIssueSql = "UPDATE [dbo].[corporate_loans] SET finance_comments = '" + finance_comments + "', "
			...
			try {
				...
				try {
					...
					message.setSubject("Business Loan " + loanRef + " edited by Finance Department");
