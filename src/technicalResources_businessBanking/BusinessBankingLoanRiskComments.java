 ...
 */
@WebServlet("/BusinessBankingLoanRiskComments")
public class BusinessBankingLoanRiskComments extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (con != null) {
			...
			String insertIssueSql = "UPDATE [dbo].[corporate_loans] SET risk_comments = '" + risk_comments + "', "
			...
			try {
				...
				try {
					...
					message.setSubject("Business Loan " + loanRef + " edited by Risk Department");
