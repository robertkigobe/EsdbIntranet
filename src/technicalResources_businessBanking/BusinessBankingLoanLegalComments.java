 ...
 */
@WebServlet("/BusinessBankingLoanLegalComments")
public class BusinessBankingLoanLegalComments extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (con != null) {
			...
			String insertIssueSql = "UPDATE [dbo].[corporate_loans] SET legal_services = '" + legal_services + "', "
			...
			try {
				...
				try {
					...
					message.setSubject("Business Loan " + loanRef + " edited by Legal Department");
