 ...
 */
@WebServlet("/OperationForms")
public class OperationForms extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	String directoryName = "C:/IntranetWarehouse/Forms/OperationForms";
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/staffServices/operationForms.jsp");
