 ...
 */
@WebServlet("/RiskPolicies")
public class RiskPolicies extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	String directoryName = "C:/IntranetWarehouse/Policies/RiskPolicies";
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher view = request
				.getRequestDispatcher("WEB-INF/staffServices/riskPolicies.jsp");
