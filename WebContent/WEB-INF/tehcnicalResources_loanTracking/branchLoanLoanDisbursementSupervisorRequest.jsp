...
<title>Loan Disbursemen Supervisor Comments</title>
...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
					...
					<form action=BranchLoanLoanDisbursementSupervisorRequest method="post" class="form col-md-7">
						...
						<label>Select Customer Loan for Comment:</label> <select name="loanReference" class="form-control">
							<c:forEach items="${pendingBrachManangerBranchLoanRequests}" var="pendingBrachManangerBranchLoanRequests">
								<option value="${pendingBrachManangerBranchLoanRequests}">${pendingBrachManangerBranchLoanRequests}</option>
							</c:forEach>
						</select>
