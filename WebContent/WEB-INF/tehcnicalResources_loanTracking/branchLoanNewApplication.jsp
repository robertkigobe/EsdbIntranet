...
<html>
<head>
<title>Branch Personal Loan Application</title>
		...
		<div>
			...
			<div>
				...
				<div style="margin-left: 40px;">
					<h3>New Branch Loan Application</h3>
					
					<div>
						<form action="BranchLoanNewApplication" method="POST">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="dateOfBirth">Date of Birth</label> <input
											type="text"  id="datepickerDob" class="form-control" name="dateOfBirth"  required>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="providentFund">Provident Fund (E)</label> <input
											...
											id="providentFund" id="providentFund" value="0.00">
									</div>
									...
									<div class="form-group col-md-2">
										<label for="medicalAid">MedicalAid (E)</label> <input
											...
											id="medicalAid" value="0.00">
									</div>
									<div class="form-group col-md-2">
										<label for="pension">Pension (E)</label> <input type="number"
											step="0.01" class="two-decimals" class="form-control"
											name="pension" id="pension" id="pension" value="0.00">
									</div>
									...
									<div class="form-group col-md-2">
										<label for="tax">Tax (E)</label> <input type="number"
											step="0.01" class="two-decimals" class="form-control"
											name="tax" id="tax" id="tax" value="0.00">
									</div>
									<div class="form-group col-md-2">
										<label for="rent">Rent (E)</label> <input type="number"
											step="0.01" class="two-decimals" class="form-control"
											name="rent" id="rent" id="rent" value="0.00">
									</div>
									<div class="form-group col-md-2">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="foodBudget">Food (E)</label> <input type="number"
											step="0.01" class="two-decimals" class="form-control"
											name="foodBudget" id="foodBudget" value="0.00">
									</div>
									<div class="form-group col-md-2">
									...
									<div class="form-group col-md-2">
										<label for="otherDeductionBudget">Other Deduction</label> <input
											...
											id="otherDeductionBudget" value="0.00">
									</div>
								</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										<label for="overdrafts">Overdrafts (E)</label> <input
											...
											step="0.01" class="two-decimals" id="overdrafts" value="0.00">
									</div>

									<div class="form-group col-md-3">
										<label for="otherDebts">Other Debts (E)</label> <input
											type="number" class="form-control" name="otherDebts"
											step="0.01" class="two-decimals" id="otherDebts" value="0.00">
									</div>
									...
									<div class="form-group col-md-3">
										<label for="surplusLiabilities">Surplus Liabilities
											...
											id="surplusLiabilities" value="0.00">
									</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-4">
										<label for="property">Property (E)</label> <input
											...
											step="0.01" class="two-decimals" id="property" value="0.00">
									</div>
								...
								<div class="form-row">
									<div class="form-group col-md-2">
										<label for="cashAtBank">Cash AtBank (E)</label> <input
											...
											step="0.01" class="two-decimals" id="cashAtBank" value="0.00">
									</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="insurances">Insurances (E)</label> <input
											...
											step="0.01" class="two-decimals" id="insurances" value="0.00">
									</div>
									<div class="form-group col-md-2">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-4">
										...
										<input type="number" class="form-control"
											...
											id="debtorsName4Amount" value="0.00">
									</div>
								</div>
							</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="dateOfLastInstallment">Last Date</label> <input
											...
											id="datepickerEndDate" value="${dateOfLastInstallment}"
									...
									<div class="form-group col-md-2">
										<label for="loanAmount">Loan Amount</label> <input
											...
											id="loanAmount" step="0.01" class="two-decimals" value="0.00"
											required>
									</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-12">
										<label for="businessConsultantComment"> Business
											...
											value="${ businessConsultantComment}" required>
									</div>
								</div>
							</div>
