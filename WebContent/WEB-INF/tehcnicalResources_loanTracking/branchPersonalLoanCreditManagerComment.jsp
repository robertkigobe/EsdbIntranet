...
<html>
<head>
<title>Credit Manager Comments</title>
		...
		<div>
			...
			<div>
				...
				<div style="margin-left: 40px;">
					<h3>Credit Manager Comments</h3>
					<div>
						<form action="BranchLoanCreditManagerComment" method="POST">
							...
							<div style="border-style: ridge">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label for="creditAnalystComment"> Credit Analyst Comment</label> <input type="text" class="form-control"
											name="creditAnalystComment"
											id="creditAnalystComment"
											value="${creditAnalystComment}" readonly>
									...
									<div class="form-group col-md-3">
										<label for="creditAnalystName">Credit Analyst Name</label> <input
											...
											id="creditAnalystName" value="${ creditAnalystName}" readonly>
									</div>
									
									
									<div class="form-group col-md-3">
										<label for="creditAnalystCommentDate">Credit Analyst Comment Date</label> <input
											type="text" class="form-control" name="creditAnalystCommentDate"
											id="creditAnalystCommentDate" value="${ creditAnalystCommentDate}" readonly>
									</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-9">
										<label for="creditAnalystComment"> Credit Manager
