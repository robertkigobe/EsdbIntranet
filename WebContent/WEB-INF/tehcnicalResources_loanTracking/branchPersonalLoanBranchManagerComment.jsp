		...
		<div>
			...
			<div>
				...
				<div style="margin-left: 40px;">
					<h3>Branch Manager Comments</h3>
					<div>
						<form action="BranchLoanBranchManagerComment" method="POST">
							...
							<div style="border-style: ridge">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										<label for="creditManagerName">Credit Analyst Name</label> <input
									...
									<div class="form-group col-md-3">
										<label for="creditAnalystEmail">Credit Analyst Email</label> <input
											type="email" class="form-control" name="creditAnalystEmail"
											id="creditAnalystEmail"  required>
									</div>
								</div>
							</div>
