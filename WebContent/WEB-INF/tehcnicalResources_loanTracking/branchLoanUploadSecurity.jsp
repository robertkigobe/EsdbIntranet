	...
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form class="form-inline" action=BranchLoanUploadSecuritiesLinks method="post" enctype="multipart/form-data">
					<div class="form-group mb-2">
						<input	type="text" readonly class="form-control" name="loanReference" value="${loanReference}"
