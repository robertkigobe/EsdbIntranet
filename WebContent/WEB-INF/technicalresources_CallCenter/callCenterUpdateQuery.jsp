	...
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action="CallCenterEditQuery" method=POST>
					...
					<div id="row" class="row">
						...
						<div class="col col-md-2">
							<label for="nameOfStaff">Response from: </label> <input
								 type="text" class="form-control " 
								name="nameOfStaff" value="">
						</div>
						<div class="col col-md-2">
							<label for="departmentResponsible">Department: </label>  <select
								class="form-control " name="departmentResponsible" readonly>
								<option>${departmentResponsible}</option>
						...
						<div class="col col-md-2">
							<label for="nameOfCustomer">Name Of Customer: </label> <input
								 type="text" class="form-control " 
								name="nameOfCustomer" value="${nameOfCustomer}">
						</div>
						...
						<div class="col col-md-2">
							<label for="emailReplyTo">Email reply to: </label> <select
								class="form-control " name="emailReplyTo" required>
								<option></option>
						...
						<div class="col col-md-2">
							<label for="emailReplyCopyTo">Email Copy to: </label> <select
								class="form-control " name="emailReplyCopyTo" required>
								<option></option>
								<option>callcenter@swazibank.co.sz</option>
								<Option>mzn@swazibank.co.sz</Option>
								<Option>mts@swazibank.co.sz</Option>
					...
					<div id="row" class="row">
						<div class="col col-md-12">
							...
							<input type="text" value="${customerQuery}" class="form-control" 
								name="customerQuery" rows="3" readonly></input>
						</div>
					</div>
					<div id="row" class="row">
						...
						<div class="col col-md-12">
							<label for="resolution">Resolution taken: </label> 
								<textarea value="${resolution}" class="form-control" 
