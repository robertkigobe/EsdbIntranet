...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				<h1>DC's for March 2018</h1>

				<div class="scroll">



					<form method="post" action="DCMARCH" class="form-horizontal">
						<div class="form-group">
							<H4>
								Search: First Name or Surname:<input type="text"
									name="seachName" placeholder="Account Number.."> <a
									href="${pageContext.request.contextPath}/DCMARCH">Clear Filters</a>
							</H4>
						</div>
					</form>

					<table class="table-striped table-hovertable-bordered">
