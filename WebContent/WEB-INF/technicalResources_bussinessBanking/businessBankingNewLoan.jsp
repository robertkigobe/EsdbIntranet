...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div>
				<div>
					<h3>New Business Banking Loan Application</h3>
					<div>
						<form action="BusinessBankingNewLoan" method="POST">
								...
								<div style="border-style: ridge">
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="collateral_security" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="exposure_to_bank" rows="3"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="recommendations" rows="10"></textarea>
										</div>
								...
								<div style="border-style: ridge">
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="curent_position" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="nature_of_business" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="non_financial_risks_analysis" rows="20"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="benefits_to_bank" rows="5"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="legal_implications" rows="5"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="account_activity_analysis" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="finance_risk_analysis" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="ratio_analysis" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="maximum_lending_limit" rows="10"></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="conclusion_and_recommendation" rows="10"></textarea>
										</div>
