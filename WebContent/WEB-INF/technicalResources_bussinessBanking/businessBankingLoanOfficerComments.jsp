...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div>
				<div>
					<h3>Business Banking Loan Amendments</h3>
					<div>
						<form action="BusinessBankingLoanOfficerComments" method="POST">
								...
								<div style="border-style: ridge">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-2">
											<label for="endDate">End Date:</label> <input type="text"
												...
												placeholder="mm/dd/yyyy" value="${endDate}" required>
										</div>

										<div class="form-group col-md-2">
											<label for="charges">Loan Amount:</label> <input type="text"
												id="charges" class="form-control" name="charges" value="${charges}" required>
										</div>

										<div class="form-group col-md-2">
											<label for="intertestRate">Interest Rate:</label> <input
												type="text" class="form-control" id="intertestRate"
												name="intertestRate" value="${intertestRate}" required>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="collateral_security" rows="10"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="exposure_to_bank" rows="3"   required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0" name="conclusion"
												rows="6"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="recommendations" rows="10"  required><c:out value="${collateral_security}" /></textarea>
										</div>
								...
								<div style="border-style: ridge">
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0" name="purpose2"
												rows="10"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="curent_position" rows="10"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="nature_of_business" rows="10"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="non_financial_risks_analysis" rows="20"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="benefits_to_bank" rows="5"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0" name="cost_to_bank"
												rows="5"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="legal_implications" rows="5"  required><c:out value="${collateral_security}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="account_activity_analysis" rows="10"  required><c:out value="${account_activity_analysis}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="finance_risk_analysis" rows="10"  required><c:out value="${finance_risk_analysis}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="ratio_analysis" rows="10"  required><c:out value="${ratio_analysis}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="maximum_lending_limit" rows="10"  required><c:out value="${maximum_lending_limit}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="conclusion_and_recommendation" rows="10"  required><c:out value="${conclusion_and_recommendation}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="finance_comments" rows="10"  ><c:out value="${finance_comments}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0" name="risk_comments"
												rows="10"  ><c:out value="${risk_comments}" /></textarea>
										</div>
									...
									<div style="border-style: ridge">
										...
										<div class="form-group">
											...
											<textarea class="form-control rounded-0"
												name="legal_services" rows="10"  ><c:out value="${legal_services}" /></textarea>
										</div>
