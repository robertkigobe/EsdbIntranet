...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div>
				<div>
					<h3>Business Banking Loan Finance Comments</h3>
					<div>
						<form action="BusinessBankingLoanFinanceComments" method="POST">
									...
									<div style="border-style: ridge">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-3">
												<label for="creditemail">Corporate Officer email:</label> <input
													type="email" class="form-control" name="creditemail"
													id="creditemail"  required>
											</div>
