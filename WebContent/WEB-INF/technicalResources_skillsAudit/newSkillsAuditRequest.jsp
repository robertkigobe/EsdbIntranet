		...
		<div>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>New Position Skills Audit</h4>
					<br>
				</div>


				<form action=SkillsAuditNewSkillsAudit method="post" class="form">
					...
					<div class="form-group">
						<input value="Submit" type="Submit" class="btn btn-primary btn-sm">
					</div>
				</form>
			</div>
		</div>
