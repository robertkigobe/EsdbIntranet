...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
					<h2>Upload Momentum Statement:</h2>

					<form action=MomentumStatementsUpload method="post"
						...
						<table>
							...
							<tr>
								<td>File UpLoad :</td>
								<td><input type="file" name="fileUpLoad" size="50" required="required" accept="application/txt"></td>
