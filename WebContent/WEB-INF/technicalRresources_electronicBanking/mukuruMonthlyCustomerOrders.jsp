	...
	<div class="container-fluid">
		...
		<div>
				...
				<ol class="list-group">
					...
					<li><a href="#"
						class="list-group-item list-group-item-action active">Import
							Worksheet</a></li>
					<li><a href="${pageContext.request.contextPath}/MukuruCustomerOrders" class="list-group-item list-group-item-dark">Customer Transactions</a></li>
			...
			<div class="rightNav">
				...
				<div>
					<form method="post" action="MukuruMonthlyCustomerOrders"
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="count">Greater than:</label> <input type="number"
									class="form-control" name="count" required>
							</div>
				...
				<div class="form-group col-md-2">
					<a style="color: red;"
						href="${pageContext.request.contextPath}/MukuruMonthlyCustomerOrders">All
				...
				<div class="scroll">
					<table class="table  table-striped table-hover table-bordered">
						...
						<tbody>
							...
							<c:forEach var="file" items="${mukuruMonthlyCustomerOrderlist}">
								<tr>
									<td><c:out value="${file.branch}" /></td>
									<td><c:out value = "${file.snap_shot }"/></td>
									<td><c:out value="${file.recipient_ID}" /></td>
									<td><c:out value="${file.recipient}" /></td>
									<td><c:out value="${file.total_count}" /></td>
									<td><c:out value="${file.total_ordered}" /></td>
									<td><c:out value="${file.total_received}" /></td>
