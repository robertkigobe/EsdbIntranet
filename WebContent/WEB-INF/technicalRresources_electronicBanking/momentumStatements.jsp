...
<html>
<head>
<title>Momentum Statement Files</title>
			...
			<div class="rightNav">
				...
				<div class="col-md-12">
					...
					<div>
						...
						<div class="list-group-item list-group-item-dark">	<a href="${pageContext.request.contextPath}/MomentumStatementsUpload">Upload Statement</a> </div>
						<div class="list-group-item list-group-item-dark">	<a href="${pageContext.request.contextPath}/MomentumStatementsReport">View Statements</a> </div>
							...
							<tbody>
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="UploadMomentumStatement"><span class="glyphicon glyphicon-download"></span>
