		...
		<div>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>Card Production Login request</h4>
					<br>
				</div>

				<form method="post" action="CardproductionLogin" class="form col-md-4">
					<div class="form-group">
					
						<select name="branch" required>
							<option></option>
							<option>SWAZIBANK HEAD OFFICE</option>
