			...
			<div class="rightNav">
				<div>
					<div class="page-header">
						<h4>Credit Department Policies and Procedures</h4>
							...
							<tbody>
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewCreditPolicies"><span class="glyphicon glyphicon-download"></span>
