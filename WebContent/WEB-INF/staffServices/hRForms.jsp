			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/HRForms"
						class="list-group-item list-group-item-action active">HR Forms</a></li>
					...
					<li><a href="${pageContext.request.contextPath}/OperationForms"
						class="list-group-item list-group-item-dark">Operation Forms</a></li>
							...
							<tbody>
								...
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewHRForms"><span class="glyphicon glyphicon-download"></span>
