			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/NewsLetter"
						class="list-group-item list-group-item-dark active">Publications</a></li>
							...
							<tbody>
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewNewsLetter"><span class="glyphicon glyphicon-download"></span>
