...
<title>Finance Department Policies and Procedures</title>
</head>
<body>
			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/FINANCEPolicies"
						class="list-group-item list-group-item-action active">Finance Policies</a></li>
					...
					<li><a href="${pageContext.request.contextPath}/ITPolicies"
						class="list-group-item list-group-item-dark">IT Policies</a></li>
			...
			<div class="rightNav">
				<div>
					<div class="page-header">
						<h4>Finance Department Policies</h4>
					...
					<div>
						<table class="table  table-striped table-hover table-bordered">
							...
							<thead class="thead-dark">
								<tr>
									<th style="width: 15%">Policy Name</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewFINANCEPolicies">
