...
<title>Risk Forms and Procedures</title>
</head>
<body>
			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/RiskPolicies"
						class="list-group-item list-group-item-action active">Risk Policies</a></li>
			...
			<div class="rightNav">
				<div>
					<div class="page-header">
						<h4>Risk Department Policies</h4>
					...
					<div class="scroll">
						...
						<c:forEach var="file" items="${fileList}">
							<tr>
								...
								<td><form method="post" action="ViewRiskPolicies"><span class="glyphicon glyphicon-download"></span>
