			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/HRPolicies"
						class="list-group-item list-group-item-action active">HR Policies</a></li>
					...
					<div>
						...
						<c:forEach var="file" items="${fileList}">
							<tr>
								...
								<td><form method="post" action="ViewHRPolicies"><span class="glyphicon glyphicon-download"></span>
