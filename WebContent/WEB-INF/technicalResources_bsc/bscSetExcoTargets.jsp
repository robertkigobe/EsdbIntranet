...
<body>
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				<form action=BscPostExcoTargets method="post">
								...
								<c:forEach var="target" items="${targets}">
									<tr>
										<td><input type="text" name=department
											value="${target.department}" readonly
										...
										<td><input type="text" name="measure"
											...
											style="border: none; word-wrap: break-word; min-width: 450px; max-width: 550px;" /></td>
