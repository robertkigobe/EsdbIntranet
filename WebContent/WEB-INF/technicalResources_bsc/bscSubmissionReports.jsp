	...
	<div class="container-fluid">
		...
		<div>
			<div class="leftNav">
				...
				<li><a href="${pageContext.request.contextPath}/BscAnnualScores" class="list-group-item list-group-item-action active">2017 - 2018 Annual  Report</a></li>
				...
				<div
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<div class="page-header">
									<h4>SwaziBank Submitted Scores</h4>
								</div>
					...
					<form method=POST action = BscDelete>
						<table class="table  table-striped table-hover table-bordered">
							...
							<c:forEach var="file" items="${submissionReport}">
								...
								<tr>
									...
									<c:out	value="${file.bscPeriodSubmission}" /></td>
									<td style="width: 300px;"><c:out
											value="${file.subDepartment}" /></td>
									<td style="width: 250px;"><c:out
											value="${file.bscEmployeeNameSubmission}" /></td>
									<td style="width: 250px;"><c:out
											value="${file.bscEmployeeSupervisorSubmission}" /></td>
									<td style="width: 300px;"><c:out
											value="${file.positionSubmission}" /></td>
