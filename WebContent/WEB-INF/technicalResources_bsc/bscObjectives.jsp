...
<html>
<head>
<title>Balance Score Card - Objectives</title>
			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/BscObjectives"
						class="list-group-item list-group-item-dark active">Objectives</a></li>
					<li><a
			...
			<div class="rightNav">
				...
				<div class="scroll">
					<table class="table  table-striped table-hover table-bordered">
						...
						<tbody>
							<c:forEach var="file" items="${objectiveList}">
								<tr>
									<td><c:out value="${file.objective}" /></td>
									<td><c:out value="${file.objectiveDesciption}" /></td>
