		...
		<div>
			<div class="leftNav">
				...
				<ol class="list-group">
					<li><a
						...
						class="list-group-item list-group-item-dark ">HSE First
							Aid</a></li>
					<li><a
			...
			<div class="rightNav container-fluid">
				...
				<div>
					...
					<div>
						<form action="HealthSafetyNewInspectionEnvironmental"
							 method="POST">
							<div id="row" class="row ">
								...
								<div class="col col-md-4">
									<label for="dateOfInspection">Date: </label> <input
										class="form-control col-md-4"  value="${dateOfInspection}" name="dateOfInspection"
										type="date" readonly />
								</div>
								<div class="col col-md-4">
									<label for="she_representative">Health and Safety Rep: </label> <select
										name="she_representative" class="form-control col-md-3" required>
											...
											<c:forEach var="it" items="${items}" varStatus="status">
												<tr>
													...
													<textarea class="form-control" rows="2"
														name="" id="comment" readonly>${it.itemDesc }</textarea>
													</td>
													</td>
							...
							<div id="row" style="margin-top: 10px" class="row">
								...
								<div class="col col-md-8">
									<label for="she_representativeComment">Health and Safety Rep
										Comments: </label>
									<textarea class="form-control" id="she_representativeComment"
										name="she_representativeComment"></textarea>
								</div>
								<div class="col col-md-4">
									<label for="dateOfFireMarshallComment">Date: </label>
									<input type="date" class="form-control input-lg" id="dateOf_she_representativeComment"
										value="${dateOf_she_representativeComment}" name="dateOf_she_representativeComment" />
								</div>
							</div>
							<div id="row" style="margin-top: 10px" class="row">
								...
								<div class="col col-md-4">
									<label for="dateOfManagerComment">Date: </label>
									<input type="date" class="form-control input-lg" id="dateOfManagerComment"
										value="${dateOfManagerComment}" name="dateOfManagerComment" />
								</div>
							</div>
							<div style="margin-top: 10px" id="row" class="row">
								...
								<div class="col col-md-4">
									<label for="dateOfwellnessCoordinatorComment">Date: </label>
									<input type="date" class="form-control input-lg"
										id="dateOfwellnessCoordinatorComment" value="${dateOfwellnessCoordinatorComment}"
