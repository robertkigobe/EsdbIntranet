			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a style="font-size: 12px;"
						...
						class="list-group-item list-group-item-dark active">View HSE
					...
					<table class="table table-hover table-bordered ">
						<thead>
							<tr>
								...
								<th style="width: 40%">Peer Educator:</th>
						...
						<tbody>
							<c:forEach var="in" items="${inspections}">
								<tr>
									<form action="HealthSafetyViewInspectionWellnessChampion"
										method="POST">
										...
										<td><input type="text" value="${in.representative}"
											name="peerEducator" class="form-control" readonly /></td>
