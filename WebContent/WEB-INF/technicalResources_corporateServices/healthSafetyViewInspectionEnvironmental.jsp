	...
	<div class="container-fluid">
		...
		<div>
			<div class="leftNav">
				<h2>Quick Links:</h2>
					...
					<li><a style="font-size:14px;"
						...
						class="list-group-item list-group-item-dark active">View HSE Environmental Submissions</a></li>
			...
			<div class="rightNav container-fluid">
				...
				<h2>Submitted Fire Marshal Reports</h2>
				<div>
					<table class="table table-hover table-bordered ">
						<thead>
							<tr>
								...
								<th style="width: 40%">SHE Representative</th>
						...
						<tbody>
							<c:forEach var="in" items="${inspections}">
								<tr>
									<form action="HealthSafetyViewInspectionEnvironmental"
										method="POST">
										...
										<td><input type="text" value="${in.representative}"
											name="she_representative" class="form-control" readonly /></td>
