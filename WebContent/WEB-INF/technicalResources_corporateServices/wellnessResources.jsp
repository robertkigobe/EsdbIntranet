			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/History"
						class="list-group-item list-group-item-dark">EswatiniBank History</a></li>
							...
							<tbody>
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewWellnessResources"><span class="glyphicon glyphicon-download"></span>
