...
<html>
<head>
<title>Forex AML Risk Transactions</title>
<style>
div.scroll {
	position: relative;
	width: 100%;
		...
		<div>
			<div class="leftNav">
					...
					<ol class="list-group">
						...
						<li><a href="#"  class="list-group-item list-group-item-action active">Forex Transactions</a></li>
						<li><a href="${pageContext.request.contextPath}/ForexAMLHighRiskDailyReport"
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<div class="page-header">
									<h4>Forex AML Risk Transactions</h4>
