		...
		<div>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>Risk Survey Login request</h4>
					<br>
				</div>

				<form method="post" action="RiskReportLogin" class="form col-md-4">
					<div class="form-group">
					
						<select name="report" required>
							<option></option>
							<option>RISK MANEGEMENT AML TEST 2017</option>
							<option>RISK MANEGEMENT SURVEY 2018</option>
							<option>RISK MANEGEMENT TEST 2018</option>						
						</select>
					</div>
					<div class="form-group">
