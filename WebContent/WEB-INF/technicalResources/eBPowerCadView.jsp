...
<title>Power Card Files for Loading to T24</title>
</head>
<body>
	<div class="container">
		<div>
		...
		<div>
			...
			<ul>
					...
					<li><a href="${pageContext.request.contextPath}/UploadPowerCardFiles">Load Power Card</a></li>
					
					<li><a href="${pageContext.request.contextPath}/EBPowerCadAdministration">View Power Card Files</a></li>
					...
					<table border="1" cellpadding="5">
						...
						<c:forEach var="file" items="${fileList}">
							<tr>
								...
								<td><form method="post" action="ViewPowerCard">
