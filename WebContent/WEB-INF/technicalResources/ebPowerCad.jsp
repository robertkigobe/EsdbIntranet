		...
		<div>
			<div class="leftNav" style="float: left; width: 20%;">
				...
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/EBPowerCadView">View T 24 Files</a></li>
					...
					<table border="1" cellpadding="5">
						...
						<c:forEach var="file" items="${fileList}">
							<tr>
								...
								<td><form method="post" action="EBPowerCadAdministration">
