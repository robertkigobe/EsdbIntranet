...
<title>Senior Hr manager Staff Loan Comments</title>
...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action=StaffLoanSeniorHrManagerRequest method="post" class="form col-md-7">
						...
						<select name="employeeLoanRef" class="form-control">
							<c:forEach items="${pendingHrManagerStaffLoanRequests}" var="pendingHrManagerStaffLoanRequests">
								<option value="${pendingHrManagerStaffLoanRequests}">${pendingHrManagerStaffLoanRequests}</option>
							</c:forEach>
						</select>
