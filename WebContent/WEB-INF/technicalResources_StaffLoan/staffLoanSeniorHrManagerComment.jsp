		...
		<div>
			...
			<div >
				...
				<div style="margin-left: 40px;">
					<h3>Senior Hr Manager Comment</h3>
					<div>
						<form action="StaffLoanUpdateSeniorHrManagerComment" method="POST">
							...
							<div style="border-style: ridge">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="Hod">Hod:</label> <input
											type="text" class="form-control" name="hod"
											id="hod" value="${hod}"
											required >
									</div>
							...
							<div style="border-style: ridge">
								...
								<div style="border-style: ridge">
									...
									<div class="form-group col-md-3">
											<label for="hodCommentDate">Paymaster Comment
												Date:</label> <input type="email" class="form-control"
												name="hodCommentDate" value="${hrPayrollMasterCommentDate}"
												readonly>
										</div>

										<div class="form-group col-md-9">
											<label for="hrPayrollMasterComment">paymaster Comment:</label> <input
									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											<label for="loanStatus">Loan Status:</label> <select
												...
												<option>Prepare Securities</option>
										...
										<div class="form-group col-md-6">
											<label for="seniorHrManagerComment">Senior HR manager Comment:</label> <input
												...
												value="${seniorHrManagerComment}" required >
										</div>
