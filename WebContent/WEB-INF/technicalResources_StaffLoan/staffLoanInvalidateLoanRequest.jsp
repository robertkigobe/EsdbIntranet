...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action=StaffLoanEmployeeInvalidateRequest method="post" class="form col-md-7">
						...
						<label>Select Employee Loan to Delegate:</label> <select name="employeeLoanRef" class="form-control">
							<c:forEach items="${pendingHodStaffLoanRequests}" var="pendingHodStaffLoanRequests">
								<option value="${pendingHodStaffLoanRequests}">${pendingHodStaffLoanRequests}</option>
							</c:forEach>
						</select>
