		...
		<div>
			...
			<div>
				...
				<div style="margin-left: 40px;">
					...
					<div>
						<form action="StaffLoanUpdateSupervisorComment" method="POST">
							...
							<div style="border-style: ridge">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-2">
										<label for="Hod">Executive Manager:</label> <select name="hod"
											class="form-control" required>
											<option></option>
											<option>Bhembe Mbongeni</option>
											<option>Dumase Nxumalo</option>
											<option>Enock Mavimbela</option>
											<option>Lindiwe Shongwe</option>
											<option>Sifiso Mdluli</option>
											<option>Tawonga Sifundza</option>
											<option>Thembi Dlamini</option>
											<option>Zakhele Mahlindza</option>
											<option>Zakhele Lukhele</option>
											<option>Zanele Dlamini</option>
										</select>
									</div>

									<div class="form-group col-md-2">
										<label for="hodEmail">EM Email:</label> <input type="email"
										...
										<div class="form-group col-md-4">
											<label for="loanAmount">Amount in words:</label> <input
												type="text" class="form-control" name="loanAmountWords"
												 placeholder="To be filled by Supervisor" required/>
										</div>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											<label for="loanStatus">Loan Status:</label> <select
												...
												<option>Send to Hod for Comment</option>
