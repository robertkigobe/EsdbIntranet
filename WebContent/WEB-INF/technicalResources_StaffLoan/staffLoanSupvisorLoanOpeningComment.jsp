...
<html>
<head>
<title>Supervisor Loan Opening Comment</title>
	...
	<div class="container-fluid">
		...
		<div>
			...
			<div>
				...
				<form action="StaffLoanUpdateSupervisorLoanOpeningComment"
					method="POST">
					...
					<div style="border-style: ridge">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="employeeCode">Employee No</label> <input type="text"
									class="form-control" name="employeeCode"
							...
							<div class="form-group col-md-2">
								<label for="surname">Last Name</label> <input type="text"
									class="form-control" name="surname" value="${surname}" required>
							</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="Hod">Hod:</label> <input type="text"
									class="form-control" name="hod" id="hod" value="${hod}"
									required>
							</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="boxAddress">Emp Post Add:</label> <input type="text"
									class="form-control" name="boxAddress" value="${boxAddress}"
									required>
							</div>
							<div class="form-group col-md-2">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label for="hodEmail">HOD Email:</label> <input type="hodEmail"
									class="form-control" name="hodEmail" value="${hodEmail}">
							</div>
					...
					<div style="border-style: ridge">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="allowances">Allowances:</label> <input type="number"
									class="form-control" name="allowances" step="0.01"
									class="two-decimals" value="${allowances}" required>
							</div>
							<div class="form-group col-md-2">
								<label for="housingloanDeductions">Housing loan Ded'n:</label> <input
							...
							<div class="form-group col-md-2">
								<label for="housingloanBalance">Housing loan Bal:</label> <input
									...
									step="0.01" class="two-decimals" value="${housingloanBalance}"
									required>
							</div>
							...
							<div class="form-group col-md-2">
								<label for="ruralHousingloanBalance">Rural Housing Bal:</label>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="farm_smallHolderBalance">Farm Small Holder
									Balance:</label> <input type="number" class="form-control" step="0.01"
									class="two-decimals" name="farm_smallHolderBalance"
							...
							<div class="form-group col-md-2">
								<label for="carloanDeductions">Car loan Deductions : </label> <input
									...
									step="0.01" class="two-decimals" value="${carloanDeductions}"
									required>
							</div>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-2">
								<label for="personalloanDeductions">Personal loan
									...
									step="0.01" class="two-decimals" name="personalloanDeductions"
									value="${personalloanDeductions}" required>
							</div>
							<div class="form-group col-md-2">
								<label for="personalloanBalance">Personal loan Balance:</label>
								<input type="number" class="form-control" step="0.01"
									class="two-decimals" name="personalloanBalance"
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="educationalloanDeductions">Educational loan
									Ded's:</label> <input type="number" class="form-control" step="0.01"
									class="two-decimals" name="educationalloanDeductions"
									value="${educationalloanDeductions}" required>
							</div>
							<div class="form-group col-md-2">
								<label for="educationalloanBalance">Educational loan
									Balance:</label> <input type="number" class="form-control" step="0.01"
									class="two-decimals" name="educationalloanBalance"
							...
							<div class="form-group col-md-2">
								<label for="cityCouncilRatesBalance">City Council Rates
									Balance:</label> <input type="number" class="form-control" step="0.01"
									class="two-decimals" name="cityCouncilRatesBalance"
									value="${cityCouncilRatesBalance}" required>
							</div>

							<div class="form-group col-md-2">
								<label for="insurancesDeductions">Insurances Deductions:</label>
						...
						<div style="border-style: ridge">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-2">
									<label for="dateOfFirstInstallment">First Installment:</label>
								...
								<div class="form-group col-md-2">
									<label for="dateOfLastInstallment">Last Installment:</label> <input
										type="text" class="form-control" name="dateOfLastInstallment"
										value="${dateOfLastInstallment}" readonly>
								</div>

								<div class="form-group col-md-2">
									<label for="loanType">Loan Type:</label> <input name="loanType"
								...
								<div class="form-group col-md-2">
									<label for="funeralCover">Funeral Cover:</label> <input
										...
										step="0.01" class="two-decimals" value="5000.00" readonly />
								</div>
						...
						<div style="border-style: ridge">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									<label for="hodCommentDate">HOD Comment Date:</label> <input
										type="email" class="form-control" name="hodCommentDate"
										value="${hodCommentDate}" readonly>
								</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									<label for="hodCommentDate">Paymaster Comment Date:</label> <input
										type="email" class="form-control" name="hodCommentDate"
										value="${hrPayrollMasterCommentDate}" readonly>
								</div>

								<div class="form-group col-md-9">
									<label for="hrPayrollMasterComment">paymaster Comment:</label>
									<input type="text" class="form-control"
										name="hrPayrollMasterComment"
										value="${hrPayrollMasterComment}" required readonly>
								</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									<label for="emailAddress">Sr Hr Mgr Comment Date:</label> <input
										type="text" class="form-control"
										name="seniorHrManagerCommentDate"
										value="${seniorHrManagerCommentDate}" readonly>
								</div>

								<div class="form-group col-md-9">
									<label for="seniorHrManagerComment">Senior HR manager
										Comment:</label> <input type="text" class="form-control"
										name="seniorHrManagerComment"
										value="${seniorHrManagerComment}" readonly>
								</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									<label for="legalAdvisorComment">Securities Supervisor
										Date Comment:</label> <input type="text" class="form-control"
										name="legalAdvisorCommentDate"
										value="${legalAdvisorCommentDate}" readonly>
								</div>

								<div class="form-group col-md-9">
									<label for="loanOpeningSupervisorEmail">Loan Opening
										Supervisor Comment:</label> <input type="text" class="form-control"
										name="legalAdvisorComment" value="${legalAdvisorComment}"
										readonly>
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label for="loanOpeningSupervisorComment">Supervisor
									Loan Opening Comment:</label> <input type="text" class="form-control"
									name="loanOpeningSupervisorComment"
									value="${loanOpeningSupervisorComment}" required>
							</div>

							<div class="form-group col-md-2">
								<label for="disbursedAmount">Amount Disbursed:</label> <input
									type="number" class="form-control" name="disbursedAmount"
									value="${disbursedAmount}" step="0.01" class="two-decimals"
									required>
							</div>
