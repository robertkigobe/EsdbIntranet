...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
					...
					<form action=StaffLoanSupervisorRequest method="post" class="form col-md-7">
						...
						<label>Select Employee Loan for Comment:</label> <select name="employeeLoanRef" class="form-control">
							<c:forEach items="${pendingSupervisorStaffLoanRequests}" var="pendingSupervisorStaffLoanRequests">
								<option value="${pendingSupervisorStaffLoanRequests}">${pendingSupervisorStaffLoanRequests}</option>
							</c:forEach>
						</select>
