		...
		<div>
			...
			<div >
				...
				<div style="margin-left: 40px;">
					<h3>HOD Comment</h3>
					<div>
						<form action="StaffLoanUpdateHodComment" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											<label for="loanStatus">Loan Status:</label> <select
												...
												<option>Send to HR for Processing</option>
										...
										<div class="form-group col-md-9">
											<label for="hodComment">Executive Manager Comment:</label> <input
												type="text" class="form-control" name="hodComment"
												value="${hodComment}" required >
										</div>
