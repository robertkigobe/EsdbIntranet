		...
		<div>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>Upload Pay Slip (PDF files only ):</h4>

				</div>

				<div>

					<form action=StaffLoanPayslipUpload method="post"
						enctype="multipart/form-data" class="form">


						<div class="form-group ">
							<label for="applicantName"><small>Please make the
									file name to be the First Name + Surname + Employee Code</small></label> 
						</div>
