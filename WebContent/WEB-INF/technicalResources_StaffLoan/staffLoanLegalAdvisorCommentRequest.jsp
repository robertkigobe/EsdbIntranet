...
<title>Legal Advisor Loan Comments</title>
...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action=StaffLoanLegalAdvisorCommentRequest method="post" class="form col-md-7">
						...
						<select name="employeeLoanRef" class="form-control">
							<c:forEach items="${pendingLegalAdvisorStaffLoanRequests}" var="pendingLegalAdvisorStaffLoanRequests">
								<option value="${pendingLegalAdvisorStaffLoanRequests}">${pendingLegalAdvisorStaffLoanRequests}</option>
							</c:forEach>
						</select>
