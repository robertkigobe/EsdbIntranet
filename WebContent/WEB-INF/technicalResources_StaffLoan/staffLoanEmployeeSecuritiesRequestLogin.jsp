...
<title>New Staff Loan Securities Request</title>
		...
		<div>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>Start Staff Loan Securities Login</h4>
					<br>
				</div>

				<form method="post" action="StaffLoanEmployeeSecuritiesRequest" class="form col-md-7">
					...
					<div class="form-group">
						<button type="submit" class="btn btn-primary">Submit</button> <small>You can contact Hr for your password</small>
					</div>
				</form>
			</div>
