		...
		<div>
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a href="${pageContext.request.contextPath}/Home"
						class="list-group-item list-group-item-action active">Home</a></li>
					<li><a href="${pageContext.request.contextPath}/VisionPage"
						class="list-group-item list-group-item-dark">Vision,
							Mission And Core Values</a></li>
					<li><a href="${pageContext.request.contextPath}/History"
						class="list-group-item list-group-item-dark">History</a></li>
					<li><a href="${pageContext.request.contextPath}/NoticeBoard"
						class="list-group-item list-group-item-dark">Notice
							Board</a></li>
			...
			<div class="rightNav">
				...
				<div class="page-header">
					<h4>Staff Loan Administration Login</h4>
					<br>
				</div>

				<form method="post" action="StaffLoanAdministrationLogin" class="form col-md-5">

					

					<div class="form-group">
						<label>Password:</label> <input type="password" name="accessCode"
							class="form-control">
					</div>
