...
<title>Securities Staff Loan Comments</title>
...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action=StaffLoanSecuritiesRequest method="post" class="form col-md-7">
						...
						<label>Select Employee Loan for Securities Preparation:</label> 
