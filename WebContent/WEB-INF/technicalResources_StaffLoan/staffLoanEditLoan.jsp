	...
	<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form method="post" action="StaffLoanEditLoan" class="form col-md-5">
				
				
				<div class="page-header">
						<label><h4>Staff Loan Edit Loan</h4></label>
					</div>
					...
					<div class="form-group">
						<label>Loan Reference:</label> <input type="text" name="employeeLoanRef"
							class="form-control">
					</div>
