...
<title>Payroll Master Staff Loan Comments</title>
...
<div class="container-fluid">
		...
		<div>
			...
			<div class="rightNav">
				...
				<form action=StaffLoanPayrollMasterRequest method="post" class="form col-md-7">
						...
						<select name="employeeLoanRef" class="form-control">
							<c:forEach items="${pendingHrStaffLoanRequests}" var="pendingHrStaffLoanRequests">
								<option value="${pendingHrStaffLoanRequests}">${pendingHrStaffLoanRequests}</option>
							</c:forEach>
						</select>
