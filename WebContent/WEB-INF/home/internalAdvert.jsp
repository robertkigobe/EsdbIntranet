			...
			<div class="leftNav">
				...
				<ol class="list-group">
					...
					<li><a
						...
						class="list-group-item list-group-item-dark active">Internal
							Vacancies</a></li>
							...
							<tbody>
								...
								<c:forEach var="file" items="${fileList}">
									<tr>
										...
										<td><form method="post" action="ViewInternalAdvert">
